    ...
    <div id="carbonads">
      <span>
        <span class="carbon-wrap">
          <a href="https://demo.horilla.com" class="carbon-img" target="_blank" rel="noopener sponsored">
            <img src="/logo-white-bg.png" border="0" height="100" width="130" data-no-statview="no"
              style="max-width: 130px;">
          </a>
        </span>
        <a href="https://horilla.com" class="carbon-poweredby" target="_blank" rel="noopener sponsored">
